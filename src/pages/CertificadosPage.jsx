import { FaFilePdf, FaLandmark } from 'react-icons/fa';
import {
...
const CertificadosPage = () => {
  const getIconForCertificate = (id) => {
    if (id.includes('anmat-importador'))
      return (
        <IoShieldCheckmarkOutline
          size={36}
    ...
    if (id.includes('anmat-distribuidor'))
      return (
        <IoRibbonOutline
          size={36}
          className='text-cyan-700'
          ...
          {certificadosData.map((certificado) => (
            ...
            >
              <div className='mb-6 flex-shrink-0'>
                {getIconForCertificate(certificado.id)}
              </div>
